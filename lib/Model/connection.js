...
Model.prototype._finishCreateConnection = function() {
  var model = this;
  this.root.shareConnection.on('error', function(err, data) {
  ...
  this.root.shareConnection.on('doc', function(shareDoc) {
...
Model.prototype.hasPending = function() {
  return this.root.shareConnection.hasPending();
};
Model.prototype.hasWritePending = function() {
  return this.root.shareConnection.hasWritePending();
};
Model.prototype.whenNothingPending = function(cb) {
  return this.root.shareConnection.whenNothingPending(cb);
};
