...
// Model.prototype.graph = function(graphName, vertex, data)
...
Model.prototype.graph = function(graphName, vertex, data, options) {
  ...
  // graphName, options
    ...
    if (typeof vertex === 'string') {
      ...
      options = vertex;
      expression = { $g: graphName, $o: options };
    }
  }
  // graph, vertex, data
  //   - or -
  // graph, vertex, options
    ...
    if (data.direction || data.$limit || data.self) {
      options = data;
      expression = { $g: graphName, $v: vertex, $o: options };
    }
    else {
      expression = { $g: graphName, $v: vertex, $d: data };
    }
  }
  // graph, vertex, data, options
  else {
    expression = { $g: graphName, $v: vertex, $d: data, $o: options };
  }
